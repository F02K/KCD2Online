...
| UI boundary | Copied POD snapshots and commands, compatibility-gated by the shared KCD2Online version (`0.1.8`) | ABI size/project-version tests; no engine pointer crosses the boundary |
